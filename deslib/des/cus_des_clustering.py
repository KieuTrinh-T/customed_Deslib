...
class Cus_DESClustering(BaseDS):
    ...
    def __init__(self, pool_classifiers=None, clustering=None,
        ...
        if not hasattr(self.clustering_, 'predict'):
            self.clustering_.predict = self.clustering_.fit_predict
    ...
    def _preprocess_clusters(self):
        ...
        """
        #handle for other cluster without predict method
